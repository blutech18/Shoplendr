                    ...
                    Builder(
                      builder: (context) {
                        ...
                        return ListView.builder(
                          ...
                          shrinkWrap: true,
                          scrollDirection: Axis.vertical,
                          itemCount: productNoSearch.length,
                          itemBuilder: (context, productNoSearchIndex) {
                            final productNoSearchItem =
                                productNoSearch[productNoSearchIndex];
                            return Padding(
                              padding: const EdgeInsets.all(12.0),
                              child: Container(
                                width: double.infinity,
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: CachedNetworkImage(
                                          ...
                                          fadeOutDuration:
                                              const Duration(milliseconds: 300),
                                          imageUrl: productNoSearchItem.photo,
                                          width: 80.0,
                                          height: 80.0,
                                          fit: BoxFit.cover,
                                        ),
